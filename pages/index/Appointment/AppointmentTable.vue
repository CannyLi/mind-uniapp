		...
		<view>
			<form @submit.prevent="submitAppointment" @reset="formReset">
				<view class="uni-form-item uni-column">
					...
					<input class="uni-input" v-model="appointment.name" required />
				</view>
				<view class="uni-form-item uni-column">
					<view class="title">电话号码</view>
					<input class="uni-input" v-model="appointment.phone" required />
				</view>
				<view class="uni-form-item uni-column">
				...
				<view class="uni-form-item uni-column">
					...
					<picker mode="selector" :range="consultIntentions" @change="onConsultIntentionChange">
						<view class="picker">{{ consultIntentions[appointment.consultIntentionIndex] || '选择咨询意向' }}</view>
					</picker>
				</view>
