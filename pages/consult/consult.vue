<template>
  <view class="container">
    <view class="chat-container">
      <!-- 聊天消息列表 -->
      <view class="message" v-for="(msg, index) in messages" :key="index" :class="{'user-message': msg.isUser, 'ai-message': !msg.isUser}">
        <view :class="['avatar', { 'user-avatar': msg.isUser, 'ai-avatar': !msg.isUser }]">
          <image class="avatar-img" :src="msg.isUser ? '/static/images/Swiper/swiper1.jpg' : '/static/images/Swiper/swiper1.jpg'" alt="avatar" />
        </view>
...
.ai-message {
  flex-direction: row; /* AI消息头像和文本在左侧 */
}

.user-message {
  flex-direction: row-reverse; /* 用户消息头像和文本在右侧 */
